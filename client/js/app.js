...
class EventsManager {
    ...
    anadirEvento(){
      ...
      if ($('#titulo').val()=="" || $('#titulo').val() == null || $('#titulo').val()==" "){
        alert("Ingrese campo Título");
        $('#titulo').focus();
        return false;
      }
      if ($('#start_date').val()=="" || $('#start_date').val() == null || $('#start_date').val()==" "){
        alert("Ingrese campo Fecha Inicio");
        $('#start_date').focus();
        return false;
      }
      if ($('#end_date').val()=="" || $('#end_date').val() == null || $('#end_date').val()==" "){
        alert("Ingrese campo Fecha fin");
        $('#end_date').focus();
        return false;
      }
    ...
    actualizarEvento(evento) {
        ...
        form_data.append('end_date', start_date) //end_date
